...
public class SqlManager {
    ...
    private static final String CREATE_TABLE_STAFF_DATA = "CREATE TABLE IF NOT EXISTS staff_data (uuid VARCHAR(36) PRIMARY KEY, staff_username VARCHAR(18), staff_channel BOOLEAN, staff_muted BOOLEAN)";
    ...
    private static final String CREATE_TABLE_STAFF_HISTORY = "CREATE TABLE IF NOT EXISTS staff_log (id INT AUTO_INCREMENT PRIMARY KEY, staff_username VARCHAR(36), staff_rank VARCHAR(18), staff_command TEXT, timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP)";
    private static final String CREATE_TABLE_BAN = "CREATE TABLE IF NOT EXISTS ban (id INT AUTO_INCREMENT PRIMARY KEY, uuid VARCHAR(36) NOT NULL, username VARCHAR(50) NOT NULL, issuer VARCHAR(50) NOT NULL, reason VARCHAR(50) NOT NULL, expire LONGTEXT NOT NULL, banned_time LONGTEXT NOT NULL, purged BOOLEAN NOT NULL DEFAULT false, purged_time LONGTEXT, purger VARCHAR(50), global BOOLEAN NOT NULL DEFAULT false, mix BOOLEAN NOT NULL DEFAULT false)";
    private static final String INSERT_STAFF_DATA = "INSERT INTO staff_data (uuid, staff_username, staff_channel, staff_muted) VALUES (?, ?, ?, ?) ON DUPLICATE KEY UPDATE staff_channel = VALUES(staff_channel), staff_muted = VALUES(staff_muted)";
