...
public class SqlManager {
    ...
    private static final String CREATE_TABLE_PLAYER_DATA = "CREATE TABLE IF NOT EXISTS CNS1_cnplayerdata_1.player_data (uuid VARCHAR(36) PRIMARY KEY, username VARCHAR(18), `group` VARCHAR(18), whitelisted BOOLEAN, muted LONGTEXT NOT NULL DEFAULT 0, first_join LONGTEXT, last_join LONGTEXT)";
